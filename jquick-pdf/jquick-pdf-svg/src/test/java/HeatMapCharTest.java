...
public class HeatMapCharTest {
    ...
    public void testBarChar1() throws IOException, ParserConfigurationException {
        ...
        String content=JHeatMapChartRenderer.generateHeatmapSvg(option,500,400);
        try {
            java.nio.file.Files.write(
                    java.nio.file.Paths.get("d://test//heatmap.svg"),
                    content.getBytes()
            );
            System.out.println("SVG文件已保存: heatmap.svg");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
