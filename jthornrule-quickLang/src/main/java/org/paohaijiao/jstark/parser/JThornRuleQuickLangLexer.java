...
public class JThornRuleQuickLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"BOOLEAN", "ASSIGN", "SEMICOLON", "WITH", "IF", "THEN", "ELSEIF", "ELSE", 
			...
			"DATE", "YEAR", "MONTH", "DAY", "TIME_ZONE", "INT", "FLOAT", "STRING", 
			"ESC", "UNICODE", "HEX", "ID", "WS", "NEWLINE"
		};
	}
	...
	public JThornRuleQuickLangLexer(CharStream input) {
		super(input);
