...
public class JQuickJSONPathLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__25", "T__26", "T__27", "T__28", "T__29", "REGEX_CHAR", "ESCAPE_SEQ", 
			"REGEX_FLAGS", "IDENTIFIER", "STRING", "ESC", "UNICODE", "HEX", "NUMBER", 
			"INT", "EXP", "WS"
		};
	}
